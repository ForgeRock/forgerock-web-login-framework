...
export const OathRegistrationInteraction = {
  ...
  play: async ({ canvasElement }) => {
    ...
    // Link is inside a collapsed <details> — not in the a11y tree yet
    expect(
      canvas.queryByRole('link', { name: 'On mobile? Open link in Authenticator.' }),
    ...
    // After opening <details>, the link enters the a11y tree
    await waitFor(() => {
      expect(
        canvas.queryByRole('link', { name: 'On mobile? Open link in Authenticator.' }),
      ).toBeVisible();
...
export const OathRegistrationErrorInteraction = {
  args: {
...
export const PushRegistrationInteraction = {
  args: {
...
export const RecoveryCodesInteraction = {
  args: {
...
export const RecoveryCodesWithNameInteraction = {
  args: {
...
export const WebAuthnAuthenticationInteraction = {
  args: {
...
export const WebAuthnRegistrationInteraction = {
  args: {
