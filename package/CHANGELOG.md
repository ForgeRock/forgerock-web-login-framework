...
* **types:** re-enables types for Widget API and adds better typing for modal ([9ae6f68](https://github.com/forgerock/forgerock-web-login-framework/commit/9ae6f68782539cc2c7dad2451d92c1cd3247c94f))
