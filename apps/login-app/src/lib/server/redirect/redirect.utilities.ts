...
/**
 * @function isOAuthAuthorizePath - Checks if the URL is an AM OAuth authorize endpoint.
 * @param {string} url - Absolute or relative URL to check.
 * @returns {boolean} True if the pathname targets an oauth2 authorize endpoint.
 */
