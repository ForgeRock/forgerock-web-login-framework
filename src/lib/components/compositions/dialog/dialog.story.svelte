...
<Dialog bind:dialogEl dialogId="myDialog">
  ...
  <h2 class="tw_flex tw_font-light tw_justify-center tw_mb-4 tw_text-4xl tw_text-gray dark:tw_text-white">Sign In</h2>
  <Input key="username" label="Username" onChange={() => {}} type="text" />
  <Button width="full" onClick={() => dialogEl.close()} style="primary">Close Me</Button>
</Dialog>
